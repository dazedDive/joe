...
const Payement = () =>{
    ...
    const booking = {
        Id_flipper : cookies.dateEtFlipper.flipperId,
        flipper_price : cookies.dateEtFlipper.price,
        ...
        Id_booking : cookies.dateEtFlipper.dateChoosen[3],
        year_location : cookies.dateEtFlipper.dateChoosen[2],
        month_location : cookies.dateEtFlipper.dateChoosen[1],
        weekend_location : cookies.dateEtFlipper.dateChoosen[0],
        time_of_rent : cookies.dateEtFlipper.timeRent,
        multiplier_time_location : 1,
        transport_price : cookies.coordonees.priceDelivery,
        tva : 20,
        total_price :(parseInt(cookies.coordonees.priceDelivery)+parseInt(cookies.dateEtFlipper.price)),
        adressFacture:nameAccount?.customer?.adresse_facturation,
        Id_customer:nameAccount?.customer?.Id_customer,
        adress_delivery:cookies.coordonees.adressL,
        cp_delivery:cookies.coordonees.inputCp,
        city_delivery:cookies.coordonees.cityLivraison,
        isdeleted:0,
        isReserved:1,
        isPayed:1
